...
Seed: `2025` · pools: metric=schema, target_completeness=80, population_overall=100.0, interlinking_overall=98.14
...
- **Attribute**: 100.0%
- **Interlinking**: 98.14%
- **Schema/mapping** (graded, cannot hit the ladder): classes 13 mapped (was 13), properties 13 mapped (was 15)
...
|---|---:|---:|---:|
| academics:isScheduledAt/On | 150 | 0 | 150 |
| academics:teaches | 75 | 75 | 0 |
| compsci:attends | 2000 | 0 | 2000 |
| compsci:teaches | 50 | 50 | 0 |
| mathsci:attends | 2000 | 2000 | 0 |
| mathsci:givesLab | 30 | 0 | 30 |
| mathsci:givesLecture | 30 | 30 | 0 |

## Schema / mapping coverage

- Dropped mappings: `academics-fullProfessor, academics-schedule-place, compsci-PostDoc, compsci-registration, mathsci-associate-prof, mathsci-lab-teacher`
- Classes lost: `(none)`
- Properties lost: `givesLab, isScheduledAt`
- Mapped classes: 13 / 13
- Mapped properties: 13 / 15
