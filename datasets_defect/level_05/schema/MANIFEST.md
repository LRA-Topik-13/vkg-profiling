...
Seed: `2025` · pools: metric=schema, target_completeness=95, population_overall=100.0, interlinking_overall=97.79
...
- **Attribute**: 100.0%
- **Interlinking**: 97.79%
- **Schema/mapping** (graded, cannot hit the ladder): classes 12 mapped (was 13), properties 15 mapped (was 15)
...
| Student | firstName | 780 | 780 | 0 | 100.0 |
| Student | lastName | 780 | 780 | 0 | 100.0 |
...
- Dropped mappings: `academics-teaching, mathsci-graduate`
- Classes lost: `GraduateStudent`
